...
<head>
    ...
    <title>Devotion Tourism - Privacy Policy</title>
...
<body>
    ...
    <section style="margin-top: 100px; background-color: #fff;">
        <div class="container custom-container">
            ...
            <p class="mb-4">
                At Devotion Travel and Tourism, we respect our valued customer's privacy and ensure not to collect any
                information other than the information relevant to make a booking with us. As such, we strive to take
                care of our customer’s right to privacy in connection with their interaction with this website. Our
                scope of commitment as part of the use of your information is outlined herein.
            </p>

            <h3 class=" mb-2 heading">Collection of Personal Information</h3>
            <p class="mb-4 paragraph">
                We collect your information mainly when you contact us to inquire about our products and services or
                make a booking with us. This usually includes your name, contact details, email ID, physical address,
                credit card or payment details, travel requisites, and referral source. Upon submission of information,
                you give consent to Devotion Travel and Tourism to use your information to process orders in an accurate
                and prompt manner.
            </p>

            <h4 class=" mb-2 heading">Use of Information</h4>
            <p class="mb-4 paragraph">
                Any personal information of a client obtained through this website will be utilised by Devotion Travel
                and Tourism to process their booking, verify credit card details, and provide relevant information
                associated with their travel or any other subsidiary services they would like to avail of. This
                information will also be used for auditing, research, and activities focused on improving the
                performance of our website.
            </p>

            <h4 class="mb-2 heading">Privacy of Your Information</h4>
            <p class="mb-4 paragraph">
                All information provided by our customers during online booking, such as their name, address, email ID,
                and credit card details, is considered private and will not be disclosed or sold to anyone except for
                certain suppliers or third parties whose involvement in the loop is fundamental for the successful
                processing of your order. But before disclosing your information, we make sure that these third parties
                abide by our privacy policy and adhere to strict safety measures.
            </p>

            <h4 class="heading mb-2">Legal Disclosure of Information</h4>
            <p class="mb-4 paragraph">
                We may disclose your information if we feel that such disclosure is pertinent to protect our company’s
                rights and/or abide by a court order or a legal proceeding.
            </p>

            <h4 class="heading mb-2">Non-Personal Information</h4>
            <p class="mb-0 paragraph">
                Devotion Travel and Tourism consistently collects data from our website, with the help of patterns via
                web logs and third-party service providers. But this data is mostly deployed to evaluate the efficiency
                of our website’s content and features.
            </p>

            <h4 class="heading mb-2">Opt-Out</h4>
            <p class="mb-0 paragraph">
                We provide options for visitors to our website to ‘opt-out’ of having their personal information used
                for certain
                purposes. For instance, if you don’t want to receive any marketing material by way of newsletters or
                promotional
                emails, you can choose to request us not to send advertising information from Devotion Travel and
                Tourism or our
                affiliate websites.
            </p>

            <h4 class="heading mb-2">Contests and Surveys</h4>
            <p class="mb-0 paragraph">
                Devotion Travel and Tourism conducts contests, drawings, and surveys every now and then. Some contests
                are organised in collaboration with a third-party sponsor, and visitors to our websites will be informed
                at the time of the contest regarding the involvement of a particular third party and their extent of
                using your personal information. Since participating in these contests is voluntary, it’s solely at your
                discretion whether or not to partake in them and reveal your personal information.
            </p>

            <h4 class="heading">Secured Transaction</h4>
            <p class="mb-0 paragraph">
                In order to maintain the accuracy of data and avoid unauthorised access to our clients’ personal
                information, we make sure that all transactions are carried out through our secured server. Moreover, we
                utilise technical safeguard systems such as encryption, socket layers, and firewalls to secure your
...
=========================== */
                    ...
                    <div class="d-flex justify-content-center" style="gap: 1rem; margin-top: 1rem;">
                        <a class="icon-circle-small d-flex align-items-center justify-content-center" target="_blank"
                            href="https://www.facebook.com/profile.php?id=100091695764298">

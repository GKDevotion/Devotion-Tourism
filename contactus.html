...
<head>
    ...
    <title>Devotion Tourism - Contact Us</title>
                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="+91" style="max-width: 60px;">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="serviceRadio"
                                                id="flightBookings" checked>
                                ...
                                <button type="submit" class="btn btn-lg mt-4"
                                    style="background-color: #ab823e; color: white; border-color: #ab823e;">Send
                                    Request</button>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex align-items-center mb-4 text-start">
                                <div class="icon-circle me-3 d-flex align-items-center justify-content-center">
                                    <img src="asset/image//icons/location.svg" width="20" height="20" alt="Location">
                                </div>
                            ...
                            <div class="d-flex align-items-center mb-4 text-start">
                                <div class="icon-circle me-3 d-flex align-items-center justify-content-center">
                                    <img src="asset/image/icons/call.svg" width="20" height="20" alt="Phone">
                                </div>
                                <p class="mb-0 text-muted w-100">
                                    +971 58 577 5469
                                </p>
                            ...
                            <div class="d-flex align-items-center mb-4 text-start">
                                <div class="icon-circle me-3 d-flex align-items-center justify-content-center">
                                    <img src="asset/image/icons/emil.svg" width="20" height="20" alt="Email">
                                </div>
                                <a href="mailto:support@devotiontourism.com"
                            ...
                            <div class="d-flex align-items-center mb-4 text-start">
                                <div class="icon-circle me-3 d-flex align-items-center justify-content-center">
                                    <img src="asset/image/icons/whatsapPng.png" width="20" height="20" alt="WhatsApp">
                                </div>
                                <a href="https://wa.me/971585775469" target="_blank"
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <a href="https://www.instagram.com/devotiontourism/"
                                    class="social-btn d-flex align-items-center justify-content-center">
                                    <img src="asset/image/icons/insta.svg" width="30" height="30" alt="Instagram">
                                </a>

                                <a href="https://www.linkedin.com/company/92558268/admin/"
                                    class="social-btn d-flex align-items-center justify-content-center">
                                    <img src="asset/image/icons/linkdn.svg" width="30" height="30" alt="LinkedIn">
                                </a>

                                <a href="https://www.linkedin.com/company/devotiontourism/"
                                    class="social-btn d-flex align-items-center justify-content-center">
                                    <img src="asset/image/icons/twitter.svg" width="30" height="30" alt="Twitter">
                                </a>

                                <a href="https://www.youtube.com/@Devotiontravelandtourism"
                                    class="social-btn d-flex align-items-center justify-content-center">
                                    <img src="asset/image/icons/youtub.svg" width="30" height="30" alt="YouTube">
                                </a>
                            </div>

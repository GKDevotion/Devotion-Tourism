...
<head>
    ...
    <style>
        ...
        .travel-section {
            background-image: url("asset/image/CoverBg.webp");
        ...
        */
        ...
        .clock-img {
            ...
            height: 120px;
            border-radius: 50%;
            background-image: url('asset/image/watch/analog-watch.png');
            background-size: cover;
            background-position: center;
            position: relative;
...
<body>
    ...
    <section class="hero-section position-relative">
        ...
        <!-- Overlay -->
        <div class="hero-overlay position-absolute top-50 start-50 translate-middle text-center w-100 px-3">
                ...
                <div class="col-md-6 col-lg-5">
                    ...
                    <ul class="list-unstyled">
                        <li class="d-flex align-items-start mb-2">
                            <i class="bi bi-geo-alt-fill me-3 mt-1" style="color: #ab823e; font-size: 1.2rem;"></i>
                            <div>
                        ...
                        <li class="d-flex align-items-start mb-2">
                            <i class="bi bi-telephone-fill me-3 mt-1" style="color: #ab823e; font-size: 1.2rem; "></i>
                            <p class="mb-0">+971 585775469</p>
                        </li>
                        <li class="d-flex align-items-start">
                            <i class="bi bi-envelope-fill me-3 mt-1" style="color: #ab823e; font-size: 1.2rem;"></i>
                            <p class="mb-0">support@devotiontourism.com</p>
                        </li>
                    </ul>

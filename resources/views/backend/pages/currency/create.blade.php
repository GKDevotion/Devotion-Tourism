        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.currency.store') }}" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="name" class="mb-0">Currency Name</label>
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter a Currency Name">
                                    @error('name')
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" placeholder="Enter a Currency Code">
                                    @error('code')
                                        <div class="error text-error">{{ $message }}</div>
                                    @enderror
                                </div>

    ...
    <div class="row align-items-center">
        ...
        <div class="col-sm-7">
            <div class="breadcrumbs-area clearfix">
                {{-- <h4 class="page-title pull-left d-none">State Edit - {{ $data->name }}</h4> --}}
                <ul class="breadcrumbs pull-left m-2">
                <li><a href="{{ route('admin.dashboard.index') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.state.index') }}">All Email</a></li>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <h3 class="pb-3">Update State</h3>
            <div class="card">
                <div class="card-body">

                    <form action="{{ route('admin.state.update', $data->id) }}" onsubmit="return onSubmitValidateForm();" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control country_id" data-required="yes" id="country_id" name="country_id">
                                                @foreach( $countryArr as $cr )
                                                    <option class="continent-id continent_id_{{$cr->continent_id}} d-none" value="{{$cr->id}}" {{$data->country_id == $cr->id ? 'Selected' : ''}}>{{$cr->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error('country_id')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="fips_code" name="fips_code" placeholder="FIPS Code" value="{{$data->fips_code}}">
                                        </div>
                                        @error('fips_code')
                                            <div class="error text-error">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="iso2" name="iso2" placeholder="ISO 2" value="{{$data->iso2}}">
                                        </div>
                                        @error('iso2')
                                            <div class="error text-error">{{ $message }}</div>
                                        @enderror

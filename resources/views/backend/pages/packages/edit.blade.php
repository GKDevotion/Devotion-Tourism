    ...
    <section class="content">
        <div class="container-fluid">
            <form method="POST" class="dropzone needsclick"
                action="{{ route('admin.package.update', [$dataArr->id]) }}" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="row">
                    <!-- left column -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="price" name="price"
                                                placeholder="{{ __('Amount') }}" value="{{ $dataArr->price }}">
                                            @if ($errors->has('price'))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="start_date" class="form-control"
                                                id="start_date"
                                                value="{{ old('start_date', $dataArr->start_date ?? '') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="end_date" class="form-control"
                                                id="end_date"
                                                value="{{ old('end_date', $dataArr->end_date ?? '') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" id="status">
                                                ...
                                                <option value="0"
                                                    {{ $dataArr->status == 0 ? 'selected' : 'd-none' }}>De-Active
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="ckeditor form-control" id="description" name="description"
                                        placeholder="{{ __('Blog Description') }}" rows="16">{{ $dataArr->description }}</textarea>
                                    @if ($errors->has('description'))
                                        <div class="error">{{ $errors->first('description') }}</div>
                                    @endif
                                </div>

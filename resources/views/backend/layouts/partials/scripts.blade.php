...
<!-- start highcharts js -->
{{-- <script src="{{ asset('public/backend/assets/js/highcharts.js')}}"></script> --}}

<!-- start zingchart js -->
{{-- <script src="{{ asset('public/backend/assets/js/zingchart.min.js')}}"></script> --}}
...
<script src="{{ asset('public/backend/assets/js/scripts.js?v=0.021') }}"></script>

<!-- Dropify Image upload -->
<script src="{{ asset('public/backend/assets/js/dropify.min.js')}}"></script>

<!-- Download CSV or PDF file -->
<script src="{{ asset('public/backend/assets/js/download.js?v=0.03')}}"></script>

...
<head>
    ...
    <title>Devotion Tourism - Global Visa</title>
    ...
    <style>
        ...
        @media (max-width: 767px) {
            ...
            /* Hide the large spacing of text group */
            /* .visa-card .d-flex.flex-column.ms-4 {
        margin-left: 0.5rem;
    } */

            /* Make Read More button smaller */
            .read-btn {
                font-size: 12px;
                padding: 3px 6px;
            }
            ...
            /* Carousel: one card at a time, center properly */
            #visaCarousel .carousel-item .row {
                display: flex;
            ...
            #visaCarousel .carousel-item .col-md-4 {
                flex: 0 0 90%;
                max-width: 90%;
            }

            /* Adjust margin between cards */
            #visaCarousel .carousel-item .col-md-4:not(:last-child) {
                margin-bottom: 15px;
            }
...
<body>
    ...
    <section class="py-5" style="background:#111827;">
        <div class="container text-center">
            ...
            <p class="fw-bold mb-1" style="color: #ab823e;">SERVICES WE PROVIDE</p>
            <h2 class="text-white mb-5">EXPLORE OUR VISA ASSISTANCE</h2>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="visa-card p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    <img src="asset/image/visa/japan.jpg" class="flag-img me-2">
                                    <div class="ms-4 text-start">
                                        <p class="visa-service-label mb-0">13-Jan-2025</p>
                                        <h5 class="country-name mb-0">Japan</h5>
                                    </div>
                                </div>
                                <a href="#" class="btn read-btn">READ MORE <i
                                        class="bi bi-arrow-right-circle-fill ms-1"></i></a>
                            </div>
                            <ul class="visa-list row row-cols-1 row-cols-md-2 g-2 mt-2">
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Student Visa & Admission
                                </li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Work Visa – H1B</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Tourist Visa</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Business Visa</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="visa-card p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    <img src="asset/image/visa/canada.jpg" class="flag-img me-2">
                                    <div class="ms-4 text-start">
                                        <p class="visa-service-label mb-0">20-Dec-2025</p>
                                        <h5 class="country-name mb-0">Canada</h5>
                                    </div>
                                </div>
                                <a href="#" class="btn read-btn">READ MORE <i
                                        class="bi bi-arrow-right-circle-fill ms-1"></i></a>
                            ...
                            <ul class="visa-list row row-cols-1 row-cols-md-2 g-2 mt-2">
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Study Permit</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Work Permit</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Visitor Visa</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Business & Investor Visa
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="visa-card p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    <img src="asset/image/visa/australia.jpg" class="flag-img me-2">
                                    <div class="ms-4 text-start">
                                        <p class="visa-service-label mb-0">28-Nov-2025</p>
                                        <h5 class="country-name mb-0">Australia</h5>
                                    </div>
                                </div>
                                <a href="#" class="btn read-btn">READ MORE <i
                                        class="bi bi-arrow-right-circle-fill ms-1"></i></a>
                            ...
                            <ul class="visa-list row row-cols-1 row-cols-md-2 g-2 mt-2">
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Student Visa (Subclass
                                    500)</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Skilled Work Visa</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Tourist Visa</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Business & Investment Visa
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="visa-card p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    <img src="asset/image/visa/european-countries.jpg" class="flag-img me-2">
                                    <div class="ms-4 text-start">
                                        <p class="visa-service-label mb-0">01-Feb-2025</p>
                                        <h5 class="country-name mb-0">European Countries</h5>
                                    </div>
                                </div>
                                <a href="#" class="btn read-btn">READ MORE <i
                                        class="bi bi-arrow-right-circle-fill ms-1"></i></a>
                            ...
                            <ul class="visa-list row row-cols-1 row-cols-md-2 g-2 mt-2">
                                ...
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Work Visa / Blue Card</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Tourist / Schengen Visa
                                </li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Business / Entrepreneur
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="visa-card p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    <img src="asset/image/visa/turkey.jpg" class="flag-img me-2">
                                    <div class="ms-4 text-start">
                                        <p class="visa-service-label mb-0">12-June-2025</p>
                                        <h5 class="country-name mb-0">Turkey</h5>
                                    </div>
                                </div>
                                <a href="#" class="btn read-btn">READ MORE <i
                                        class="bi bi-arrow-right-circle-fill ms-1"></i></a>
                            ...
                            <ul class="visa-list row row-cols-1 row-cols-md-2 g-2 mt-2">
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Student Visa</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Work Visa</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Tourist Visa</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> Business / Investment Visa
                                </li>
                            </ul>
                    ...
                    <div class="swiper-slide">
                        <div class="visa-card p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    <img src="asset/image/visa/united-states.jpg" class="flag-img me-2">
                                    <div class="ms-4 text-start">
                                        <p class="visa-service-label mb-0">30-Oct-2025</p>
                                        <h5 class="country-name mb-0">United States</h5>
                                    </div>
                                </div>
                                <a href="#" class="btn read-btn">READ MORE <i
                                        class="bi bi-arrow-right-circle-fill ms-1"></i></a>
                            ...
                            <ul class="visa-list row row-cols-1 row-cols-md-2 g-2 mt-2">
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> F-1 Student Visa</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> H-1B Work Visa</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> B-1/B-2 Tourist Visa</li>
                                <li class="col"><i class="bi bi-arrow-right-circle me-2"></i> L-1 / Business Visa</li>
                            </ul>
                        </div>
                    </div>

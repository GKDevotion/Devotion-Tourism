 ...
 <footer class="bg-white pt-5 text-center">
     ...
     <div class="container">
         ...
         <ul class="nav justify-content-center pt-3">
             ...
             <li class="nav-item"><a class="nav-link text-dark fw-semibold" href="aboutus.php">About US</a></li>
             <li class="nav-item"><a class="nav-link text-dark fw-semibold" href="contactus.php">Contact Us</a></li>
             <li class="nav-item"><a class="nav-link text-dark fw-semibold" href="carrear.php">Career</a></li>
         </ul>
         ...
         <div class="d-flex justify-content-center gap-3 small mb-2">
             <a href="privacy_policy.php" class="text-dark text-decoration-none">Privacy Policy</a>
             <span>|</span>
             <a href="terms_of_service.php" class="text-dark text-decoration-none">Terms of Service</a>
             <span>|</span>
             <a href="cookies.php" class="text-dark text-decoration-none">Cookies Settings</a>
         </div>

         <p class="small text-muted">
             © <?php echo date('Y'); ?> Devotion. All rights reserved.
         </p>

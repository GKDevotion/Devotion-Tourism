...
<head>
    ...
    <title>Devotion Tourism - Carrear</title>
        ...
        <div class="container custom-container text-white">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-center mb-4 mb-md-0">
                    <img src="asset\image\333.webp" alt="Career Image" class="img-fluid career-image">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <form class="career-form">
                        ...
                        <input type="text" class="form-control mb-3" id="designation" placeholder="Designation">

                        <input type="text" class="form-control mb-3" id="totalExperience"
                        ...
                        <button type="submit" class="btn submit-btn w-100"
                            style="background-color: #ab823e; color: white;">Submit Now</button>

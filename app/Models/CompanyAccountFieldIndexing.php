...
class CompanyAccountFieldIndexing extends Model
{
    use HasFactory;

    protected $table = 'account_management_fields_indexing';
     ...
     */
    protected $fillable = [
        'company_id', 'account_mgt_field_id', 'status', 'is_hidden', 'sort_order'
    ];

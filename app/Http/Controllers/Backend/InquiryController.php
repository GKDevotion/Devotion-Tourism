...
class InquiryController extends Controller
{
    ...
    public function index( Request $request )
    {
        ...
        if (!$this->user->can('inquiry.view')) {
            abort(403, 'Sorry !! You are Unauthorized to view Inquiry !');
        }
        ...
        $admins = Inquiry::where( $where )->get();
    ...
    public function create()
    {
        ...
        if (!$this->user->can('inquiry.create')) {
            abort(403, 'Sorry !! You are Unauthorized to create Inquiry !');
        }
    ...
    public function edit(int $id)
    {
        ...
        if (!$this->user->can('inquiry.edit')) {
            abort(403, 'Sorry !! You are Unauthorized to edit Inquiry !');
        }
    ...
    {
        if (is_null($this->user) || !$this->user->can('inquiry.delete')) {
            abort(403, 'Sorry !! You are Unauthorized to delete Inquiry !');
        }

...
class CustomersController extends Controller
{
    ...
    public function create()
    {
        ...
        $religionArr  = Religion::where(['status' => 1])->get();
        return view('backend.pages.customers.create', compact('religionArr'));
    }
    ...
    public function edit(int $id)
    {
        ...
        $admin = Admin::find($id);
        $roles  = Role::all();
        return view('backend.pages.customers.edit', compact('admin', 'roles'));
    }
